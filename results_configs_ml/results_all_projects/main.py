...
class Dataframe:
    ...
    def run_rq2(self):
        ...
        models = ['DecisionTreeModel', 'GradientBoostingRegressorModel', 'LinearSVMModel', 'RandomForestModel']
        filtered = merged[merged['model'].isin(models)]
...
if __name__ == "__main__":
    ...
    for directory in config_directories:
        ...
        dataframe_rq2 = Dataframe(feature_importance_json, performance_csv, directory).run_rq2()
        dataframe_rq2.to_csv(os.path.join((directory), 'rq2.csv'), index=False)